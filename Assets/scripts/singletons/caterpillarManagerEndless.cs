...
public class caterpillarManagerEndless : MonoBehaviour {

	private static caterpillarManagerEndless _instance;

	public static caterpillarManagerEndless Instance {
		get {
			if (_instance == null) {
				GameObject go = new GameObject ("caterpillarManagerEndless");
				go.AddComponent<caterpillarManagerEndless> ();
			}
			return _instance;
		}
	}
	...
	public float minVel = 0.5f;		//minimum possible velocity for caterpillar
